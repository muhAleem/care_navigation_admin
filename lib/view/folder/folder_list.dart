import 'package:care_navigation_admin_panel/controller/folder/folder_list.dart';
...
class FolderList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<FolderListController>(
      init: FolderListController(),
      builder: (_) {
        return Scaffold(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: CommonTextFormField(_.search, 'Search Folder',
