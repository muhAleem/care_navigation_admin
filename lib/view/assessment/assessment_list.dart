import 'package:care_navigation_admin_panel/controller/assessment/assessment_list_controller.dart';
import 'package:care_navigation_admin_panel/controller/noticeboard/notice_board_list_controller.dart';
import 'package:care_navigation_admin_panel/controller/policy/policy_list_controller.dart';
...
class AssessmentData extends StatelessWidget {
  const AssessmentData({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    return GetBuilder<AssessmentListController>(
      init: AssessmentListController(),
      builder: (_) {
        return Scaffold(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: CommonTextFormField(_.search, 'Search Policy',
