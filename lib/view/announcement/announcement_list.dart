import 'package:care_navigation_admin_panel/controller/announcement/announcement_list_controller.dart';
...
class AnnouncementData extends StatelessWidget {
  const AnnouncementData({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    return GetBuilder<AnnouncementListController>(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: CommonTextFormField(_.search, 'Search Announcemen',
