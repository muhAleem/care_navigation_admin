import 'package:care_navigation_admin_panel/controller/noticeboard/noticeboard_controller.dart';
...
class NoticeBoard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<AddNoticeController>(
      init: AddNoticeController(),
      builder: (_) {
        return Scaffold(
          body: Column(
            children: [
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: const [
                                            Text(
                                              'Are you sure to publish this notice?',
                                              style: TextStyle(
                                                  color: Colors.black,
                                                  fontSize: 25,
